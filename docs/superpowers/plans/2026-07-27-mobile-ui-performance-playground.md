...
- [x] **Step 1: Create configuration and scripts**
  ...
  Define scripts `dev`, `typecheck`, `lint`, `format:check`, `test`, `test:watch`, `build`, `preview`; pin React/Vite/Vitest-compatible dependencies and set package version to `0.1.0+20260727.1050.draft` until the first commit exists.
